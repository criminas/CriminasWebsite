...
Security Vulnerabilities: Please do not report security vulnerabilities via public issues. Instead, email us directly at security@criminas.org.
Feature Requests
...
Code Contributions
    ...
    Find an Issue: Look for good first issue or help wanted tags.
    Fork & Clone: Pull the code to your local environment.
    Branch: Create a descriptive branch (e.g., feature/secure-handshake).
    Code: Write clear, documented code. Ensure you follow the project's specific style guide.
    Test: Never submit a PR without tests. Ensure all existing tests pass.
    PR: Open a Pull Request with a clear description of your changes.
